/* =============================================================================
Test 5 for joystick_MSXBIOS SDCC Library (fR3eL Project)
Version: 1.3 (17/01/2025)
Architecture: MSX
Format: MSX 8K ROM
...
const char text_AppAbout[] = "Test 5 joystick_MSXBIOS Lib";
const char text_title[] = ">Test STICK() & STRIG()";
...
void test(void)
{
  ...
  while(1)
  {
    ...
    VLOCATE(25,19);
	if (STRIG(JOYSTICKB_BUTTONA)==-1) VPRINT("~");
    else VPRINT(" ");

    VLOCATE(28,19);
	if (STRIG(JOYSTICKB_BUTTONB)==-1) VPRINT("~");
    else VPRINT(" ");
