...
0x54,0x65,0x73,0x74,0x20,0x53,0x44,0x43,0x43,0x20,0x6A,0x6F,0x79,0x73,0x74,0x69,
0x63,0x6B,0x20,0x6C,0x69,0x62,0x72,0x61,0x72,0x79,0x20,0x20,0x20,0x20,0x20,0x20,
...
void test()
{
  ...
  while(1)
  {
    ...
    if (STRIG(1)<0) VPRINT(10,19,"~");
    else VPRINT(10,19," ");

    if (STRIG(3)<0) VPRINT(13,19,"~");
    else VPRINT(13,19," ");
    ...
    if (STRIG(2)<0) VPRINT(25,19,"~");
    else VPRINT(25,19," ");

    if (STRIG(4)<0) VPRINT(28,19,"~");
    else VPRINT(28,19," ");
